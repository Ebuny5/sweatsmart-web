...
Generated by SweatSmart - Track your hyperhidrosis patterns`;
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Self-Management Strategies - Enhanced Layout */}
      <Card id="self-management">
        ...
        <CardContent className="space-y-6">
          <div className="grid gap-6 lg:grid-cols-2">
            <div className="space-y-6">
              <div className="p-6 border rounded-xl bg-gradient-to-br from-blue-50 to-blue-100 border-blue-200">
                ...
                <div className="space-y-3 text-sm">
                  <div className="p-4 bg-white rounded-lg shadow-sm border border-blue-100">
                    <div className="font-medium text-blue-900 mb-1">✓ Breathable Fabrics</div>
                    <div className="text-blue-700">Choose cotton, merino wool, and moisture-wicking materials for better air circulation</div>
                  </div>
                  <div className="p-4 bg-white rounded-lg shadow-sm border border-blue-100">
                    <div className="font-medium text-blue-900 mb-1">✓ Loose-Fitting Clothes</div>
                    <div className="text-blue-700">Wear loose garments to improve air flow and reduce heat buildup</div>
                  </div>
                  <div className="p-4 bg-white rounded-lg shadow-sm border border-blue-100">
                    <div className="font-medium text-blue-900 mb-1">✓ Extra Shirts Ready</div>
                    <div className="text-blue-700">Carry backup shirts or undershirts for quick changes when needed</div>
                  </div>
                  <div className="p-4 bg-white rounded-lg shadow-sm border border-blue-100">
                    <div className="font-medium text-blue-900 mb-1">✓ Sweat-Proof Undershirts</div>
                    <div className="text-blue-700">Use specialized undershirts with moisture barriers for extra protection</div>
                  </div>
                </div>
              </div>
              
              <div className="p-6 border rounded-xl bg-gradient-to-br from-green-50 to-green-100 border-green-200">
                ...
                <div className="space-y-3 text-sm">
                  <div className="p-4 bg-white rounded-lg shadow-sm border border-green-100">
                    <div className="font-medium text-green-900 mb-1">🧘 Deep Breathing</div>
                    <div className="text-green-700">Practice 4-7-8 breathing before stressful situations to calm your nervous system</div>
                  </div>
                  <div className="p-4 bg-white rounded-lg shadow-sm border border-green-100">
                    <div className="font-medium text-green-900 mb-1">💪 Progressive Muscle Relaxation</div>
                    <div className="text-green-700">Tense and release muscle groups to reduce physical tension and anxiety</div>
                  </div>
                  <div className="p-4 bg-white rounded-lg shadow-sm border border-green-100">
                    <div className="font-medium text-green-900 mb-1">📱 Mindfulness Apps</div>
                    <div className="text-green-700">Use meditation apps like Headspace or Calm for daily stress management</div>
                  </div>
                  <div className="p-4 bg-white rounded-lg shadow-sm border border-green-100">
                    <div className="font-medium text-green-900 mb-1">💭 Positive Self-Talk</div>
                    <div className="text-green-700">Build confidence with prepared affirmations and realistic perspectives</div>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-6">
              <div className="p-6 border rounded-xl bg-gradient-to-br from-orange-50 to-orange-100 border-orange-200">
                ...
                <div className="space-y-3 text-sm">
                  <div className="p-4 bg-white rounded-lg shadow-sm border border-orange-100">
                    <div className="font-medium text-orange-900 mb-1">🌶️ Avoid Trigger Foods</div>
                    <div className="text-orange-700">Skip spicy foods, caffeine, and alcohol before important events or social situations</div>
                  </div>
                  <div className="p-4 bg-white rounded-lg shadow-sm border border-orange-100">
                    <div className="font-medium text-orange-900 mb-1">💧 Smart Hydration</div>
                    <div className="text-orange-700">Stay hydrated but time your fluid intake to avoid excessive sweating during events</div>
                  </div>
                  <div className="p-4 bg-white rounded-lg shadow-sm border border-orange-100">
                    <div className="font-medium text-orange-900 mb-1">📝 Food Diary</div>
                    <div className="text-orange-700">Track what you eat before episodes to identify personal trigger foods</div>
                  </div>
                  <div className="p-4 bg-white rounded-lg shadow-sm border border-orange-100">
                    <div className="font-medium text-orange-900 mb-1">🧊 Cooling Foods</div>
                    <div className="text-orange-700">Try mint tea, cucumber water, or cold fruits to help regulate body temperature</div>
                  </div>
                </div>
              </div>
              
              <div className="p-6 border rounded-xl bg-gradient-to-br from-purple-50 to-purple-100 border-purple-200">
                ...
                <div className="space-y-3 text-sm">
                  <div className="p-4 bg-white rounded-lg shadow-sm border border-purple-100">
                    <div className="font-medium text-purple-900 mb-1">❄️ Pre-Cooling Techniques</div>
                    <div className="text-purple-700">Apply cold water to wrists and neck 10 minutes before going out</div>
                  </div>
                  <div className="p-4 bg-white rounded-lg shadow-sm border border-purple-100">
                    <div className="font-medium text-purple-900 mb-1">🌀 Portable Cooling</div>
                    <div className="text-purple-700">Carry small fans, cooling towels, or neck wraps for instant relief</div>
                  </div>
                  <div className="p-4 bg-white rounded-lg shadow-sm border border-purple-100">
                    <div className="font-medium text-purple-900 mb-1">⏰ Timing Activities</div>
                    <div className="text-purple-700">Schedule outdoor activities during cooler morning or evening hours</div>
                  </div>
                  <div className="p-4 bg-white rounded-lg shadow-sm border border-purple-100">
                    <div className="font-medium text-purple-900 mb-1">🧽 Cooling Wipes</div>
                    <div className="text-purple-700">Keep face and body cooling wipes for quick touch-ups throughout the day</div>
                  </div>
                </div>
              </div>
            </div>
