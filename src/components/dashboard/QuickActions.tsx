      ...
      <div className="space-y-5 px-4 -mt-7">
        ...
        <div>
          ...
          <div className="bg-white rounded-2xl border border-gray-100 p-4 shadow-sm space-y-3">
            <p className="text-xs text-gray-500">Follow <strong>Giftovate Therapeutics</strong> for tips, community stories &amp; updates</p>
            <div className="flex gap-3">
              <a
                href="https://www.instagram.com/giftovatetherapeutics"
                target="_blank"
                rel="noopener noreferrer"
                className="flex-1 flex items-center justify-center gap-2 py-3 rounded-xl bg-gradient-to-r from-purple-500 via-pink-500 to-orange-400 text-white font-bold text-xs shadow-md hover:shadow-lg hover:scale-[1.02] transition-all"
              >
              ...
              <a
                href="https://www.facebook.com/giftovatetherapeutics"
                target="_blank"
                rel="noopener noreferrer"
                className="flex-1 flex items-center justify-center gap-2 py-3 rounded-xl bg-gradient-to-r from-blue-600 to-blue-500 text-white font-bold text-xs shadow-md hover:shadow-lg hover:scale-[1.02] transition-all"
              >
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
                Facebook
              </a>
            </div>
            <p className="text-[10px] text-gray-400 text-center">📍 Akure, Nigeria</p>
          </div>
        </div>
