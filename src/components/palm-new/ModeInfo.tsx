...
const ModeInfo: React.FC = () => {
  return (
    <div className="w-full max-w-4xl mx-auto mb-8">
      <h2 className="text-lg font-bold text-white mb-4 text-center sm:text-left tracking-tight">
            ...
            >
              ...
              <ul className="space-y-1">
                {details.ranges.map((range) => (
                  <li key={range} className="text-xs text-purple-200/60 leading-relaxed">
                    {range}
                  </li>
                ))}
              </ul>
