...
export const MODE_DETAILS: Record<SimulationMode, { color: string; textColor: string; ranges: string[] }> = {
  Resting: {
    color: 'bg-green-500',
...
export const STATUS_DETAILS: Record<FusedStatus, { color: string; textColor: string; ringColor: string; }> = {
  'Stable': {
    color: 'bg-green-500',
    textColor: 'text-green-400',
