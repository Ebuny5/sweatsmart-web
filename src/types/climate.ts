...
EOFcd ~/sweatsmart-web

# Create icons.tsx (run the command I gave you above)
cat > src/components/climate/icons.tsx << 'EOF'
import React from 'react';

export const ThermometerIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 16.5V3.5a2.5 2.5 0 00-5 0v13a2.5 2.5 0 005 0z" />
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 16.5a2.5 2.5 0 01-5 0" />
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 13.5h2M9 10.5h2" />
  </svg>
);

export const DropletIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 22a8 8 0 00-8-8c0-4.418 3.582-8 8-8s8 3.582 8 8a8 8 0 00-8 8z" />
