    ...
    <div className="relative rounded-2xl overflow-hidden mb-4 p-4"
      ...
      <div className="flex items-start gap-3 relative">
        ...
        <div className="flex-1 min-w-0">
          <p className="text-[10px] font-bold text-teal-400 uppercase tracking-widest mb-1">Hidro Ally · Specialist Radar</p>
        ...
        <div className="p-5 pb-10">
          ...
          <div className="rounded-xl p-3.5 mb-5"
            ...
            <div className="flex items-center gap-2 mb-1.5">
              ...
              <span className="text-[10px] font-bold text-teal-400 uppercase tracking-wider">Hidro Ally Insight</span>
            </div>
