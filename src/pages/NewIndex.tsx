        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
            ...
            <div className="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition-shadow">
              ...
              <h3 className="text-xl font-bold text-gray-900 text-center mb-3">Hidro Ally Companion</h3>
              <p className="text-gray-600 text-center mb-4">
              ...
              <button onClick={() => navigate('/hyper-ai')} className="w-full py-2 text-pink-500 font-medium hover:bg-pink-50 rounded-lg transition">Chat with Hidro Ally</button>
            </div>
