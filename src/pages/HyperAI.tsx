...
import { Send, Sparkles, Loader2, Copy, Check, Download, Mic, MicOff,
  ...
  Zap, AlertTriangle, PenSquare, History, ImagePlus, X } from 'lucide-react';
...
const WELCOME_MESSAGE: Message = {
  role: 'assistant',
  content: "Hey, good to have you here. What's on your mind?",
};
      ...
      >
        ...
        >
          ...
          <div className="flex items-center gap-1.5">
            ...
            {/* Icon buttons */}
            {/* New chat button — pencil icon like Claude/Gemini */}
            <button
