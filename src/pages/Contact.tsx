    ...
    <AppLayout>
      <div className="container max-w-4xl mx-auto space-y-8">
        ...
        <Card className="border-border/50 shadow-sm">
          ...
          <CardContent className="space-y-4">
            <p className="font-semibold text-foreground text-center text-lg">Giftovate Therapeutics</p>
            ...
            <div className="flex items-center justify-center gap-4 py-2">
              ...
              <button
                ...
                className="w-12 h-12 rounded-full flex items-center justify-center text-white transition-transform hover:scale-110 active:scale-95"
              ...
              {/* LinkedIn */}
              <button
                onClick={() => window.open('https://www.linkedin.com/company/giftovatetherapeutics', '_blank')}
                className="w-12 h-12 rounded-full flex items-center justify-center text-white transition-transform hover:scale-110 active:scale-95"
              ...
              {/* Twitter / X */}
              <button
                onClick={() => window.open('https://www.twitter.com/giftovatetherapeutics', '_blank')}
                className="w-12 h-12 rounded-full flex items-center justify-center text-white transition-transform hover:scale-110 active:scale-95"
