...
const SweatSmartLanding = () => {
  ...
  const features = [
    ...
    {
      icon: "🌤",
      title: "Proactive Climate Alerts",
      desc: "Stay ahead of the sweat. Our system triggers "High Risk" notifications before an episode starts by tracking real-time heat, humidity, and UV levels tuned to the African HH Trigger Baseline (28°C and 70% humidity).",
      accent: "#e879f9",
    },
    {
      icon: "🎯",
