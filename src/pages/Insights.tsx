        ...
        <div className="space-y-4 px-4 -mt-6">
          ...
          >
            ...
            <div className="flex-1">
              <p className="text-white font-black text-sm">Deep-dive with Hidro Ally</p>
              <p className="text-purple-100 text-xs mt-0.5 leading-snug">
                Ask personalised questions like "What can I do about my work sweating?" — Hidro Ally reads your full history.
              </p>
            </div>
          </button>
