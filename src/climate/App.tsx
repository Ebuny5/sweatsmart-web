...
import { ThermometerIcon, DropletIcon, SunIcon, ZapIcon, BellIcon, MapPinIcon, RefreshIcon } from './components/icons';
...
function App() {
    ...
    useEffect(() => {
        // Only run simulation if permissions are NOT granted
    ...
    return (
        <div className="bg-gray-900 text-white min-h-screen font-sans p-2 sm:p-4">
            <div className="max-w-md mx-auto space-y-4">
                <header className="text-center py-2">
                    <h1 className="text-3xl font-bold text-cyan-400">Sweat Smart</h1>
